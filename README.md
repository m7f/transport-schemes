...
Реализован проект будет в виде web-приложения, при помощи связки html + css + js. Также будет использоваться nodejs. Географические данные будут взяты из [Open Street Map](http://openstreetmap.ru/) и [OverPass](https://overpass-turbo.eu/).
Данные об остановках можно будет найти на официальных сайтах Санкт-Петербурга, туристических или в Википедии.
